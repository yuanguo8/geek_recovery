...
try_update_binary(const char *path, ZipArchive *zip) {
    ...
    if (binary_entry == NULL) {
        ...
        if (update_script_entry != NULL) {
            printf("Amend scripting (update-script) is no longer supported.\n");
            printf("Amend scripting was deprecated by Google in Android 1.5.\n");
            printf("It was necessary to remove it when upgrading to the ClockworkMod 3.0 Gingerbread based recovery.\n");
            printf("Please switch to Edify scripting (updater-script and update-binary) to create working update zip packages.\n");
